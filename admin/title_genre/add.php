...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO Title_Genre (title_id, genre_id) VALUES ('$title_id', '$genre_id')";
...
<div class="container">
    <div class="toolbar">
        <div class="title">เพิ่ม Title Genre</div>
        <a href="list.php" class="btn">กลับรายการ Title Genre</a>
    </div>
    ...
    <form method="POST">
        ...
        <label for="genre_id">ประเภทหนังสือ</label>
