...
<div class="table-control">
    ...
    <div class="order-container">
        ...
        <select id="orderSelect" onchange="orderTable()">
            ...
            <option value="return_date">วันที่คืน</option>
            <option value="fine_fee">ค่าปรับ</option>
        </select>
    </div>
</div>
...
function orderTable() {
    ...
    rows.sort((a,b)=>{
        ...
        switch(key){
            ...
            case "return_date": aText=a.cells[7].textContent; bText=b.cells[7].textContent; break;
            case "fine_fee": aText=parseFloat(a.cells[8].textContent); bText=parseFloat(b.cells[8].textContent); break;
        }
