...
$sql = "SELECT ta.title_id, ta.author_id, t.series_name AS title_name, a.author_name
...
<body>
    ...
    <div class="toolbar">
        <div class="title">Title Author List</div>
        <div class="actions">
        ...
        <table>
            ...
            <tbody>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <tr>
                        <td data-label="Title"><?= htmlspecialchars($row['title_name']) ?></td>
                        <td data-label="Author"><?= htmlspecialchars($row['author_name']) ?></td>
                        <td class="td-actions" data-label="Action">
                            <a href="edit.php?title_id=<?= $row['title_id'] ?>&author_id=<?= $row['author_id'] ?>">Edit</a>
                            <a href="delete.php?title_id=<?= $row['title_id'] ?>&author_id=<?= $row['author_id'] ?>" onclick="return confirm('Delete this record?')">Delete</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
