...
<head>
    <meta charset="UTF-8">
    <title>เพิ่มสำนักพิมพ์ (Publisher)</title>
    <style>
        body {
...
<div class="container">
    <div class="toolbar">
        <div class="title">เพิ่มสำนักพิมพ์ (Publisher)</div>
        <a href="list.php" class="btn">กลับรายการสำนักพิมพ์</a>
    </div>

    <form method="post">
        <label for="publisher_name">ชื่อสำนักพิมพ์</label>
        <input type="text" name="publisher_name" id="publisher_name" required>
        <input type="submit" name="submit" value="เพิ่มสำนักพิมพ์">
    </form>
</div>
